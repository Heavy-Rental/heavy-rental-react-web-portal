...
- GIVEN a documentation accuracy pass against running code and workflows
...
- AND it updates `specification/` and the matching OpenSpec capability in the same change when a fact drifted
